...
// - version: The PAIN_014_001_VESION specifying the version of the document.
//
// Returns:
...
func (w *DrawdownResponseWrapper) CreateDocument(modelJson []byte, version DrawdownResponse.PAIN_014_001_VESION) ([]byte, error) {
