...
func (w *EndpointDetailsReportWrapper) CreateDocument(modelJson []byte, version EndpointDetailsReport.CAMT_052_001_VERSION) ([]byte, error) {
...
func (w *EndpointDetailsReportWrapper) ValidateDocument(modelJson string, version EndpointDetailsReport.CAMT_052_001_VERSION) error {
	// Unmarshal the JSON string into the MessageModel
	var model EndpointDetailsReport.MessageModel
