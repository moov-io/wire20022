...
// - version: The PAIN_013_001_VERSION specifying the version of the document.
//
// Returns:
...
func (w *DrawdownRequestWrapper) CreateDocument(modelJson []byte, version DrawdownRequest.PAIN_013_001_VERSION) ([]byte, error) {
...
func (w *DrawdownRequestWrapper) ValidateDocument(modelJson string, version DrawdownRequest.PAIN_013_001_VERSION) error {
	// Unmarshal the JSON string into the MessageModel
	var model DrawdownRequest.MessageModel
