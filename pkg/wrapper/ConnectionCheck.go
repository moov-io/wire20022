...
// - version: The ADMI_004_001_VESION specifying the version of the document.
//
// Returns:
...
func (w *ConnectionCheckWrapper) CreateDocument(modelJson []byte, version ConnectionCheck.ADMI_004_001_VESION) ([]byte, error) {
