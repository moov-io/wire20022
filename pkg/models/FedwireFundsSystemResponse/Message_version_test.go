...
func TestVersion01(t *testing.T) {
	...
	require.Equal(t, err.Error(), "field copy SysEvtAck.MsgId failed: failed to set MessageId: InvalideMessageIdLength5012345678901234567890 fails validation with length 45 <= required maxLength 35")
