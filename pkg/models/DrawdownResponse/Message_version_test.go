...
func TestVersion01(t *testing.T) {
	...
	require.Equal(t, err.Error(), "field copy CstmrPmtStsRpt.GrpHdr.MsgId failed: failed to set MessageId: InvalideMessageIdLength5012345678901234567890 fails validation with length 45 <= required maxLength 35")
...
func DrawdownResponseDataModel() MessageModel {
	...
	message.CreditorAgent = models.Agent{
		PaymentSysCode:     models.PaymentSysUSABA,
