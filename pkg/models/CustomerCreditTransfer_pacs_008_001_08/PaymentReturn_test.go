...
func TestPaymentReturnCreateXML(t *testing.T) {
	...
	jsonFileName := filepath.Join("generated", "PaymentReturn.json")
	xnlFileName := filepath.Join("generated", "PaymentReturn.xml")
