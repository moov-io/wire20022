...
func TestMessageRejectCreateXML(t *testing.T) {
	...
	jsonFileName := filepath.Join("generated", "MessageReject.json")
	xnlFileName := filepath.Join("generated", "MessageReject.xml")
