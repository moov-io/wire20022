...
The `EndpointTotalsReport` package is part of the [`moov-io/wire20022`](https://github.com/moov-io/wire20022) library. It provides functionality for handling ISO 20022 Endpoint Totals Report messages (`camt.052`) across multiple versions. This package includes tools for creating, validating, and converting between XML documents and Go data models.
...
```bash
go get github.com/moov-io/wire20022/pkg/EndpointTotalsReport
```
...
```go
    ...
    doc, err := DocumentWith(model, EndpointTotalsReport.CAMT_052_001_08)
    if err != nil {
        log.Fatal(err)
    }
```
