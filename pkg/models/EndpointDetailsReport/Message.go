...
// Note: Version-specific validation is now handled by ValidateForVersion() method
...
// CheckRequiredFieldsForVersion has been replaced with the type-safe ValidateForVersion method
