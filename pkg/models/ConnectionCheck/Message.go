...
//	defer file.Close()
//	err := model.WriteXML(file, ConnectionCheck.{VERSION_CONST})
//
//	// Write to buffer
...
func (m *MessageModel) WriteXML(w io.Writer, version ...ADMI_004_001_VERSION) error {
...
// Example:
//
//	doc, err := ConnectionCheck.DocumentWith(model, VERSION_LATEST)
//	if err != nil {
//	    return err
//	}
