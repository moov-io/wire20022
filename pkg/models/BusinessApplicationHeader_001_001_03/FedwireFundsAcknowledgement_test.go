...
func TestFedwireFundsAcknowledgement_Scenario1_Step1a_head(t *testing.T) {
	...
	mesage.model.BusinessMessageId = "20250310QMGFNP6200070203101000FT03"
	mesage.model.MessageDefinitionId = "admi.007.001.01"
...
func TestFedwireFundsAcknowledgement_Scenario1_Step2a_head(t *testing.T) {
	...
	mesage.model.MessageSenderId = "011104238"
	mesage.model.MessageReceiverId = "021151080"
	mesage.model.BusinessMessageId = "20250310QMGFNP6200070303101000FT03"
	mesage.model.MessageDefinitionId = "admi.007.001.01"
	mesage.model.BusinessService = "TEST"
	mesage.model.MarketInfo = MarketPractice{
		ReferenceRegistry: "www2.swift.com/mystandards/#/group/Federal_Reserve_Financial_Services/Fedwire_Funds_Service",
...
func TestFedwireFundsAcknowledgement_Scenario1_Step3a_head(t *testing.T) {
	...
	mesage.model.MessageSenderId = "011104238"
	mesage.model.MessageReceiverId = "021151080"
	mesage.model.BusinessMessageId = "20250310QMGFNP6200070403101000FT03"
	mesage.model.MessageDefinitionId = "admi.007.001.01"
	mesage.model.BusinessService = "TEST"
	mesage.model.MarketInfo = MarketPractice{
		ReferenceRegistry: "www2.swift.com/mystandards/#/group/Federal_Reserve_Financial_Services/Fedwire_Funds_Service",
...
func TestFedwireFundsAcknowledgement_Scenario2_Step2a_head(t *testing.T) {
	...
	mesage.model.MessageSenderId = "011104238"
	mesage.model.MessageReceiverId = "021151080"
	mesage.model.BusinessMessageId = "20250310QMGFNP6200070503101000FT03"
	mesage.model.MessageDefinitionId = "admi.007.001.01"
	mesage.model.BusinessService = "TEST"
	mesage.model.MarketInfo = MarketPractice{
		ReferenceRegistry: "www2.swift.com/mystandards/#/group/Federal_Reserve_Financial_Services/Fedwire_Funds_Service",
...
func TestFedwireFundsAcknowledgement_Scenario2_Step3a_head(t *testing.T) {
	...
	mesage.model.MessageSenderId = "011104238"
	mesage.model.MessageReceiverId = "021151080"
	mesage.model.BusinessMessageId = "20250310QMGFNP6200070603101000FT03"
	mesage.model.MessageDefinitionId = "admi.007.001.01"
	mesage.model.BusinessService = "TEST"
	mesage.model.MarketInfo = MarketPractice{
		ReferenceRegistry: "www2.swift.com/mystandards/#/group/Federal_Reserve_Financial_Services/Fedwire_Funds_Service",
