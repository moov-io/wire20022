...
func TestInvestigations_Scenario1_Step2_head(t *testing.T) {
	...
	mesage.model.BusinessMessageId = "20250310QMGFT015000901"
	mesage.model.MessageDefinitionId = "camt.110.001.01"
...
func TestInvestigations_Scenario1_Step3_head(t *testing.T) {
	...
	mesage.model.MessageSenderId = "021040078"
	mesage.model.MessageReceiverId = "021151080"
	mesage.model.BusinessMessageId = "20250310B1QDRCQR000901"
	mesage.model.MessageDefinitionId = "camt.111.001.01"
	mesage.model.BusinessService = "TEST"
	mesage.model.MarketInfo = MarketPractice{
		ReferenceRegistry: "www2.swift.com/mystandards/#/group/Federal_Reserve_Financial_Services/Fedwire_Funds_Service",
		FrameworkId:       "frb.fedwire.acr.01",
