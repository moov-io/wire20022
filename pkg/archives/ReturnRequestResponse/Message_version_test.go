...
func ReturnRequestResponseDataModel() MessageModel {
	...
	message.Status = Archive.ReturnRequestRejected
	...
	message.CancellationStatusReasonInfo = Archive.Reason{
		Reason:         "LEGL",
