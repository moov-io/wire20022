...
type MessageModel struct {
	AssignmentId                 string
	Assigner                     Archive.Agent
	Assignee                     Archive.Agent
	AssignmentCreateTime         time.Time
	ResolvedCaseId               string
	Creator                      Archive.Agent
...
func DocumentWith(model MessageModel, version CAMT_029_001_VESION) (Archive.ISODocument, error) {
