...
type MessageModel struct {
	...
	ClearingSystem                    Archive.CommonClearingSysCodeType
...
func DocumentWith(model MessageModel, version PACS_004_001_VESION) (Archive.ISODocument, error) {
