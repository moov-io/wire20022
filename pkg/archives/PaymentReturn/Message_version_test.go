...
func TestVersion2(t *testing.T) {
	...
	require.Equal(t, model.SettlementMethod, Archive.SettlementCLRG)
	require.Equal(t, model.ClearingSystem, Archive.ClearingSysFDW)
...
func TestVersion8(t *testing.T) {
	...
	require.Equal(t, model.RtrChain.DebtorAgent.PaymentSysCode, Archive.PaymentSysUSABA)
	...
	require.Equal(t, model.RtrChain.CreditorAgent.PaymentSysCode, Archive.PaymentSysUSABA)
...
func PaymentReturnDataModel() MessageModel {
	...
	message.SettlementMethod = Archive.SettlementCLRG
	message.ClearingSystem = Archive.ClearingSysFDW
	...
	message.ReturnedInterbankSettlementAmount = Archive.CurrencyAndAmount{
		Amount:   151235.88,
		Currency: "USD",
	}
	message.InterbankSettlementDate = fedwire.ISODate(civil.DateOf(time.Now()))
	message.ReturnedInstructedAmount = Archive.CurrencyAndAmount{
		Amount:   151235.88,
		Currency: "USD",
	}
	message.ChargeBearer = Archive.ChargeBearerSLEV
	...
	message.RtrChain = Archive.ReturnChain{
		Debtor: Archive.Party{
			Name: "Corporation B",
	...
	message.ReturnReasonInformation = Archive.Reason{
		Reason:         "DUPL",
		AdditionalInfo: "Order cancelled. Ref:20250310B1QDRCQR000721.",
	}
	message.OriginalTransactionRef = Archive.InstrumentCTRC
	return message
}
