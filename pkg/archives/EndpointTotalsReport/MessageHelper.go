...
type MessageHelper struct {
	...
	TotalEntriesPerBankTransactionCode Archive.NumberAndStatusOfTransactionsHelper
...
func BuildMessageHelper() MessageHelper {
	return MessageHelper{
		...
		TotalEntriesPerBankTransactionCode: Archive.BuildNumberAndStatusOfTransactionsHelper(),
		AdditionalReportInfo: Archive.ElementHelper{
