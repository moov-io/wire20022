...
// Validations for urn:iso:std:iso:20022:tech:xsd:camt.060.001.02
...
func (v AccountReportingRequestV02) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "AccountReportingRequestV02"
...
func (v GroupHeader43) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "GroupHeader43"
...
func (v ReportingPeriod1) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ReportingPeriod1"
...
func (v ReportingRequest2) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ReportingRequest2"
	if v.Id != nil {
		fedwire.AddError(&errs, baseName+".Id", v.Id.Validate())
	}
...
func (v TransactionType1) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "TransactionType1"
