...
type MessageHelper struct {
	...
	ReportRequestId    Archive.ElementHelper
	RequestedMsgNameId Archive.ElementHelper
	AccountOtherId     Archive.ElementHelper
	AccountProperty    Archive.ElementHelper
	AccountOwnerAgent  Archive.AgentHelper
	FromToSeuence      Archive.SequenceRangeHelper
}
...
func BuildMessageHelper() MessageHelper {
	return MessageHelper{
		...
		AccountOwnerAgent: Archive.BuildAgentHelper(),
		FromToSeuence:     Archive.BuildSequenceRangeHelper(),
	}
}
