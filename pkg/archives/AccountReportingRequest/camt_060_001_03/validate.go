...
// Validations for urn:iso:std:iso:20022:tech:xsd:camt.060.001.03
...
func (v AccountReportingRequestV03) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "AccountReportingRequestV03"
...
func (v GroupHeader59) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "GroupHeader59"
...
func (v ReportingRequest3) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ReportingRequest3"
	if v.Id != nil {
		fedwire.AddError(&errs, baseName+".Id", v.Id.Validate())
	}
