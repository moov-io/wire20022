...
// Validations for urn:iso:std:iso:20022:tech:xsd:camt.060.001.06
...
func (v AccountReportingRequestV06) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "AccountReportingRequestV06"
...
func (v GroupHeader77) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "GroupHeader77"
...
func (v ReportingRequest6) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ReportingRequest6"
	if v.Id != nil {
		fedwire.AddError(&errs, baseName+".Id", v.Id.Validate())
	}
