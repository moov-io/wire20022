...
type MessageModel struct {
	MessageId  string
	EventCode  Archive.FundEventType
	EventParam string
	EventTime  time.Time
}

var NameSpaceModelMap = map[string]Archive.DocumentFactory{
	"urn:iso:std:iso:20022:tech:xsd:admi.011.001.01": func() Archive.ISODocument {
...
func DocumentWith(model MessageModel, version ADMI_011_001_VESION) (Archive.ISODocument, error) {
