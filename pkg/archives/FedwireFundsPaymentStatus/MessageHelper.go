...
type MessageHelper struct {
	...
	TransactionStatus                Archive.ElementHelper
	AcceptanceDateTime               Archive.ElementHelper
	EffectiveInterbankSettlementDate Archive.ElementHelper
	StatusReasonInformation          Archive.ElementHelper
	ReasonAdditionalInfo             Archive.ElementHelper
