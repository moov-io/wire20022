...
// Validations for urn:iso:std:iso:20022:tech:xsd:camt.052.001.07
...
func (v AccountReport22) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "AccountReport22"
...
func (v BankToCustomerAccountReportV07) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "BankToCustomerAccountReportV07"
...
func (v CardEntry3) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CardEntry3"
	if v.Card != nil {
...
func (v CardTransaction16) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CardTransaction16"
	if v.Card != nil {
		fedwire.AddError(&errs, baseName+".Card", v.Card.Validate())
	}
	if v.POI != nil {
...
func (v CashAccount36) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CashAccount36"
	fedwire.AddError(&errs, baseName+".Id", v.Id.Validate())
	if v.Tp != nil {
		fedwire.AddError(&errs, baseName+".Tp", v.Tp.Validate())
	}
...
func (v EntryDetails8) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "EntryDetails8"
	if v.Btch != nil {
...
func (v EntryTransaction9) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "EntryTransaction9"
	if v.Refs != nil {
...
func (v GroupHeader73) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "GroupHeader73"
	fedwire.AddError(&errs, baseName+".MsgId", v.MsgId.Validate())
	fedwire.AddError(&errs, baseName+".CreDtTm", v.CreDtTm.Validate())
	if v.MsgRcpt != nil {
...
func (v PaymentReturnReason3) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentReturnReason3"
...
func (v ProprietaryParty4) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ProprietaryParty4"
	fedwire.AddError(&errs, baseName+".Tp", v.Tp.Validate())
	fedwire.AddError(&errs, baseName+".Pty", v.Pty.Validate())
	if errs.Empty() {
		return nil
...
func (v RemittanceInformation15) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "RemittanceInformation15"
	if v.Ustrd != nil {
...
func (v ReportEntry9) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ReportEntry9"
	if v.NtryRef != nil {
...
func (v StructuredRemittanceInformation15) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "StructuredRemittanceInformation15"
	if v.RfrdDocInf != nil {
...
func (v TaxInformation6) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "TaxInformation6"
	if v.Cdtr != nil {
...
func (v TransactionAgents4) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "TransactionAgents4"
	if v.InstgAgt != nil {
...
func (v TransactionParties4) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "TransactionParties4"
	if v.InitgPty != nil {
