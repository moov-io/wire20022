...
func (v AccountReport25) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "AccountReport25"
...
func (v CardEntry4) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CardEntry4"
	if v.Card != nil {
...
func (v CardTransaction17) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CardTransaction17"
	if v.Card != nil {
		fedwire.AddError(&errs, baseName+".Card", v.Card.Validate())
	}
	if v.POI != nil {
...
func (v CashAccount39) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CashAccount39"
	fedwire.AddError(&errs, baseName+".Id", v.Id.Validate())
	if v.Tp != nil {
		fedwire.AddError(&errs, baseName+".Tp", v.Tp.Validate())
	}
...
func (v EntryDetails9) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "EntryDetails9"
	if v.Btch != nil {
...
func (v EntryTransaction10) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "EntryTransaction10"
	if v.Refs != nil {
...
func (v ReportEntry10) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ReportEntry10"
	if v.NtryRef != nil {
...
func (v TransactionParties6) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "TransactionParties6"
	if v.InitgPty != nil {
