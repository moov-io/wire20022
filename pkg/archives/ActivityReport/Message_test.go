...
func TestDocumentToModel08(t *testing.T) {
	...
	require.Equal(t, Archive.CAMTReportType("ACTR"), model.MessageId, "Failed to get MessageId")
	...
	require.Equal(t, model.ReportId, Archive.EveryDay, "Failed to get ReportId")
	...
	require.Equal(t, model.TotalEntriesPerBankTransactionCode[0].BankTransactionCode, Archive.Sent, "Failed to get TotalEntriesPerBankTransactionCode")
	...
	require.Equal(t, model.TotalEntriesPerBankTransactionCode[1].BankTransactionCode, Archive.TransReceived, "Failed to get TotalEntriesPerBankTransactionCode")
	...
	require.Equal(t, model.EntryDetails[0].CreditDebitIndicator, Archive.Debit, "Failed to get CreditDebitIndicator")
	require.Equal(t, model.EntryDetails[0].Status, Archive.Book, "Failed to get Status")
	require.Equal(t, model.EntryDetails[0].BankTransactionCode, Archive.TransDebit, "Failed to get BankTransactionCode")
	...
	require.Equal(t, model.EntryDetails[0].EntryDetails.InstructingAgent.PaymentSysCode, Archive.PaymentSysUSABA, "Failed to get PaymentSysCode")
	...
	require.Equal(t, model.EntryDetails[0].EntryDetails.InstructedAgent.PaymentSysCode, Archive.PaymentSysUSABA, "Failed to get PaymentSysCode")
	...
	require.Equal(t, model.EntryDetails[0].EntryDetails.LocalInstrumentChoice, Archive.InstrumentCTRC, "Failed to get LocalInstrumentChoice")
	require.Equal(t, model.EntryDetails[0].EntryDetails.RelatedDatesProprietary, Archive.BusinessProcessingDate, "Failed to get RelatedDatesProprietary")
	...
	require.Equal(t, model.EntryDetails[1].CreditDebitIndicator, Archive.Debit, "Failed to get CreditDebitIndicator")
	require.Equal(t, model.EntryDetails[1].Status, Archive.Book, "Failed to get Status")
	require.Equal(t, model.EntryDetails[1].BankTransactionCode, Archive.TransDebit, "Failed to get BankTransactionCode")
	...
	require.Equal(t, model.EntryDetails[1].EntryDetails.InstructingAgent.PaymentSysCode, Archive.PaymentSysUSABA, "Failed to get PaymentSysCode")
	...
	require.Equal(t, model.EntryDetails[1].EntryDetails.InstructedAgent.PaymentSysCode, Archive.PaymentSysUSABA, "Failed to get PaymentSysCode")
	...
	require.Equal(t, model.EntryDetails[1].EntryDetails.LocalInstrumentChoice, Archive.InstrumentCTRC, "Failed to get LocalInstrumentChoice")
	require.Equal(t, model.EntryDetails[1].EntryDetails.RelatedDatesProprietary, Archive.BusinessProcessingDate, "Failed to get RelatedDatesProprietary")
	...
	require.Equal(t, model.EntryDetails[2].CreditDebitIndicator, Archive.Debit, "Failed to get CreditDebitIndicator")
	require.Equal(t, model.EntryDetails[2].Status, Archive.Book, "Failed to get Status")
	require.Equal(t, model.EntryDetails[2].BankTransactionCode, Archive.TransDebit, "Failed to get BankTransactionCode")
	...
	require.Equal(t, model.EntryDetails[2].EntryDetails.InstructingAgent.PaymentSysCode, Archive.PaymentSysUSABA, "Failed to get PaymentSysCode")
	...
	require.Equal(t, model.EntryDetails[2].EntryDetails.InstructedAgent.PaymentSysCode, Archive.PaymentSysUSABA, "Failed to get PaymentSysCode")
	...
	require.Equal(t, model.EntryDetails[2].EntryDetails.LocalInstrumentChoice, Archive.InstrumentCTRC, "Failed to get LocalInstrumentChoice")
	require.Equal(t, model.EntryDetails[2].EntryDetails.RelatedDatesProprietary, Archive.BusinessProcessingDate, "Failed to get RelatedDatesProprietary")
}
...
func ActivityReportDataModel() MessageModel {
	...
	mesage.MessageId = Archive.ActivityReport
	mesage.CreatedDateTime = time.Now()
	mesage.Pagenation = Archive.MessagePagenation{
		PageNumber:        "1",
		LastPageIndicator: true,
	}
	mesage.ReportId = Archive.EveryDay
	mesage.ReportCreateDateTime = time.Now()
	mesage.AccountOtherId = "011104238"
	mesage.TotalEntries = "61"
	mesage.TotalCreditEntries = Archive.NumberAndSumOfTransactions{
		NumberOfEntries: "29",
		Sum:             8775299.29,
	}
	mesage.TotalDebitEntries = Archive.NumberAndSumOfTransactions{
		NumberOfEntries: "27",
		Sum:             9932294.43,
	}
	mesage.TotalEntriesPerBankTransactionCode = []Archive.TotalsPerBankTransactionCode{
		{
			NumberOfEntries:     "0",
	...
	mesage.EntryDetails = []Archive.Entry{
		{
			...
			EntryDetails: Archive.EntryDetail{
				...
				RelatedDatesProprietary: Archive.BusinessProcessingDate,
