...
// Validations for urn:iso:std:iso:20022:tech:xsd:camt.052.001.12
...
func (v AccountReport33) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "AccountReport33"
...
func (v BankToCustomerAccountReportV12) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "BankToCustomerAccountReportV12"
...
func (v CashAccount43) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CashAccount43"
	if v.Id != nil {
		fedwire.AddError(&errs, baseName+".Id", v.Id.Validate())
	}
	if v.Tp != nil {
...
func (v Charges15) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "Charges15"
...
func (v ChargesRecord8) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ChargesRecord8"
	fedwire.AddError(&errs, baseName+".Amt", v.Amt.Validate())
	if v.CdtDbtInd != nil {
		fedwire.AddError(&errs, baseName+".CdtDbtInd", v.CdtDbtInd.Validate())
	}
...
func (v EntryDetails13) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "EntryDetails13"
	if v.Btch != nil {
...
func (v EntryTransaction14) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "EntryTransaction14"
	if v.Refs != nil {
...
func (v GroupHeader116) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "GroupHeader116"
	fedwire.AddError(&errs, baseName+".MsgId", v.MsgId.Validate())
	fedwire.AddError(&errs, baseName+".CreDtTm", v.CreDtTm.Validate())
	if v.MsgRcpt != nil {
...
func (v NameAndAddress18) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "NameAndAddress18"
	fedwire.AddError(&errs, baseName+".Nm", v.Nm.Validate())
...
func (v PaymentReturnReason8) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentReturnReason8"
...
func (v ProprietaryAgent5) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ProprietaryAgent5"
	fedwire.AddError(&errs, baseName+".Tp", v.Tp.Validate())
	fedwire.AddError(&errs, baseName+".Agt", v.Agt.Validate())
	if errs.Empty() {
		return nil
...
func (v ProprietaryParty6) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ProprietaryParty6"
	fedwire.AddError(&errs, baseName+".Tp", v.Tp.Validate())
	fedwire.AddError(&errs, baseName+".Pty", v.Pty.Validate())
	if errs.Empty() {
		return nil
...
func (v RemittanceLocation8) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "RemittanceLocation8"
	if v.RmtId != nil {
...
func (v RemittanceLocationData2) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "RemittanceLocationData2"
...
func (v ReportEntry14) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ReportEntry14"
	if v.NtryRef != nil {
...
func (v TransactionAgents6) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "TransactionAgents6"
	if v.InstgAgt != nil {
...
func (v TransactionParties12) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "TransactionParties12"
	if v.InitgPty != nil {
