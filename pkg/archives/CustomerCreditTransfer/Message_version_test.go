...
func TestVersion02(t *testing.T) {
	...
	require.Equal(t, model.SettlementMethod, Archive.SettlementMethodType("CLRG"))
	require.Equal(t, model.CommonClearingSysCode, Archive.CommonClearingSysCodeType("FDW"))
	...
	require.Equal(t, model.InstrumentPropCode, Archive.InstrumentPropCodeType("CTRC"))
	...
	require.Equal(t, model.ChargeBearer, Archive.ChargeBearerSLEV)
	...
	require.Equal(t, model.InstructingAgents.PaymentSysCode, Archive.PaymentSysUSABA)
	...
	require.Equal(t, model.RemittanceInfor.CodeOrProprietary, Archive.CodeCINV)
	...
	_, err = DocumentWith(model, modelName)
	require.NotNil(t, err, "Expected error but got nil")
	require.Equal(t, err.Error(), "required field MessageId is missing")
	model.MessageId = "20250310B1QDRCQR000001"
}
...
func CustomerCreditTransferDataModel() MessageModel {
	...
	mesage.SettlementMethod = Archive.SettlementCLRG
	mesage.CommonClearingSysCode = Archive.ClearingSysFDW
	...
	mesage.InstrumentPropCode = Archive.InstrumentCTRC
	mesage.InterBankSettAmount = Archive.CurrencyAndAmount{
		Currency: "USD", Amount: 510000.74,
	}
	mesage.InterBankSettDate = fedwire.ISODate(civil.DateOf(time.Now()))
	mesage.InstructedAmount = Archive.CurrencyAndAmount{
		Currency: "USD", Amount: 510000.74,
	}
	mesage.ChargeBearer = Archive.ChargeBearerSLEV
	mesage.ChargesInfo = []ChargeInfo{
		{
			Amount:         Archive.CurrencyAndAmount{Currency: "USD", Amount: 90.00},
			BusinessIdCode: "BANZBEBB",
		},
		{
			Amount:         Archive.CurrencyAndAmount{Currency: "USD", Amount: 40.00},
			BusinessIdCode: "BANCUS33",
		},
	}
	mesage.InstructingAgents = Archive.Agent{
		PaymentSysCode:     Archive.PaymentSysUSABA,
		PaymentSysMemberId: "011104238",
	}
	mesage.InstructedAgent = Archive.Agent{
		PaymentSysCode:     Archive.PaymentSysUSABA,
		PaymentSysMemberId: "021040078",
	}
	mesage.DebtorName = "Corporation A"
	mesage.DebtorAddress = Archive.PostalAddress{
	...
	mesage.DebtorAgent = Archive.Agent{
		PaymentSysCode:     Archive.PaymentSysUSABA,
		PaymentSysMemberId: "011104238",
		BankName:           "Bank A",
		PostalAddress: Archive.PostalAddress{
			StreetName:     "Avenue A",
			BuildingNumber: "66",
			PostalCode:     "60532",
			TownName:       "Lisle",
	...
	mesage.CreditorAgent = Archive.Agent{
		PaymentSysCode:     Archive.PaymentSysUSABA,
		PaymentSysMemberId: "021040078",
		BankName:           "Bank B",
		PostalAddress: Archive.PostalAddress{
	...
	mesage.CreditorPostalAddress = Archive.PostalAddress{
	...
	mesage.RemittanceInfor = RemittanceDocument{
		CodeOrProprietary: Archive.CodeCINV,
		Number:            "INV34563",
