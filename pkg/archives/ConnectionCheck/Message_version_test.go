...
func TestVersion01(t *testing.T) {
	...
	err = Archive.WriteXMLToGenerate("ConnectionCheck_01.xml", xmlData)
	require.NoError(t, err)

	/*Create Date Model from XML (Read XML)*/
	var xmlDoc, xmlErr = Archive.ReadXMLFile("./generated/ConnectionCheck_01.xml")
...
func TestVersion02(t *testing.T) {
	...
	require.NoError(t, err)
	err = Archive.WriteXMLToGenerate("ConnectionCheck_02.xml", xmlData)
	require.NoError(t, err)

	/*Create Date Model from XML (Read XML)*/
	var xmlDoc, xmlErr = Archive.ReadXMLFile("./generated/ConnectionCheck_02.xml")
	require.NoError(t, xmlErr, "Failed to read XML file")
